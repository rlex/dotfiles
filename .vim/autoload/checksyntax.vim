...
" {{{ Nginx
if !exists('g:checksyntax_compiler_nginx')
    let g:checksyntax_compiler_nginx = 'nginx'
endif
if !exists('g:checksyntax_okrx_php')
    let g:checksyntax_okrx_php = 'test is successful'
endif
" }}}
...
" {{{ Varnish
if !exists('g:checksyntax_compiler_varnish')
    let g:checksyntax_compiler_varnish = 'varnishd'
endif
if !exists('g:checksyntax_failrx_varnish')
    let g:checksyntax_failrx_varnish = 'Running VCC-compiler failed, exit 1'
endif
" }}}
...
" {{{ Perl
" FIXME
if !exists('g:checksyntax_compiler_perl')
    let g:checksyntax_compiler_perl = 'perlck'
endif
"if !exists('g:checksyntax_okrx_perl')
    "let g:checksyntax_okrx_perl = 'syntax OK'
"endif
" }}}
