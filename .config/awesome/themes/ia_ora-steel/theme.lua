...
-- {{{ Main
theme   = {}
theme.name = "ia_ora-steel"
confdir = awful.util.getdir("config")
theme.path = confdir .. "/themes/" .. theme.name
...
theme.bg_focus  = "#106699"
theme.bg_urgent = "#9C0D0D"
-- }}}

-- {{{ Borders
theme.border_width  = "1"
theme.border_normal = "#E1E1E1"
theme.border_focus  = "#0F6090"
theme.border_marked = "#006E26"
-- }}}

-- {{{ Titlebars
theme.titlebar_bg_focus  = "#4967AE"
...
-- {{{ Misc icons
theme.awesome_icon           = theme.path .. "/icons/awesome.png"
